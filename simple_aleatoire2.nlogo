...
to go
  ...
  ;; ask reines [go-reine ]
  ask reines [move-in-squares 8]
  tick
end

to go-abeille
  if maReine = nobody [set maReine one-of reines in-radius radius]
  if maReine != nobody [set heading towards maReine]
  agiter
  fd 1
end
